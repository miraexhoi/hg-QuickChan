  ...
  return (
    <div className="all">
        ...
        <div className='contents'>
          ...
          <div className='texts'><span className='point'>택시 호출</span>이 성공적으로</div>
          <div className='texts'><span className='point'>완료</span>되었습니다!</div>
          <span className='more'>시니어 위치 보러가기</span>
          </div>
        </div>
    </div>
  )
